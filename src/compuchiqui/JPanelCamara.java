    ...
    public void paintComponent(Graphics g){
        ...
        if(imgOrig!=null){
            ...
            if(getHeight()>getWidth()){
                ...
                h = (getWidth()*imgOrig.getHeight(null))/imgOrig.getWidth(null);
            }else if(getHeight()<=getWidth()){
                h = getHeight();
                w = (getHeight()*imgOrig.getWidth(null))/imgOrig.getHeight(null);
                if(getWidth()<imgOrig.getWidth(null) ){
                    h = (getWidth()*imgOrig.getHeight(null))/imgOrig.getWidth(null);
                    if(getWidth()>=getHeight()){
                        w = (h*imgOrig.getWidth(null))/imgOrig.getHeight(null);
                    }
                    if(getHeight()<=h){
                        w = (getHeight()*imgOrig.getWidth(null))/imgOrig.getHeight(null);
                        h = getHeight();
            ...
            if(getHeight()>imgOrig.getHeight(null)&&getWidth()>imgOrig.getWidth(null)){
                w = imgOrig.getWidth(null);
                h = imgOrig.getHeight(null);
            }
            
            int x = (w<getWidth())?(getWidth()/2)-(w/2):0;
            int y = (h<getHeight())?(getHeight()/2)-(h/2):0;
            g.drawImage(imgOrig, x, y, w, h, this);                                    
        }       
    }
